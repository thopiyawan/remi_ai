$(document).ready(function () {
    ...
    var splitDate = parseInt(formattedDate.slice(-2));
    // console.log(splitDate)
    formattedDate = formattedDate.slice(0,6)+splitDate;
    // console.log(">>"+formattedDate)
    // clickCell(formattedDate)
    ...
    $('div.cal-cell.cell[date-id='+formattedDate+']').trigger('click');
    clickCell(formattedDate)
...
function clickCell(datePicked){
        var selectedDate = datePicked;
        ...
        $('#selectedDateRange').find('h3').text(moment(selectedDate).format('DD MMMM YYYY'));
        
        $('#inputdate').val(moment(selectedDate).format('YYYY-MM-DD'));
    }
